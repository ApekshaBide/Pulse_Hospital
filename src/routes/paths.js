...
export const paths = {
  ...
  dashboard: {
    ...
    pharmacy: {
      ...
      overview: `${ROOTS.DASHBOARD}/pharmacy`,
      categories: `${ROOTS.DASHBOARD}/pharmacy/categories`,
      category: (id) => `${ROOTS.DASHBOARD}/pharmacy/category/${id}`,
      categoryProducts: (id) => `${ROOTS.DASHBOARD}/pharmacy/category/${id}/products`,
      products: `${ROOTS.DASHBOARD}/pharmacy/products`,
      product: (id) => `${ROOTS.DASHBOARD}/pharmacy/product/${id}`,
      cart: `${ROOTS.DASHBOARD}/pharmacy/cart`,
      checkout: `${ROOTS.DASHBOARD}/pharmacy/checkout`,
      orders: `${ROOTS.DASHBOARD}/pharmacy/orders`,
      order: (id) => `${ROOTS.DASHBOARD}/pharmacy/order/${id}`,
      inventory: `${ROOTS.DASHBOARD}/pharmacy/inventory`,
      configuration: `${ROOTS.DASHBOARD}/pharmacy/configuration`,
      reports: `${ROOTS.DASHBOARD}/pharmacy/reports`,
      demo: {
        category: `${ROOTS.DASHBOARD}/pharmacy/category/${MOCK_ID}`,
        product: `${ROOTS.DASHBOARD}/pharmacy/product/${MOCK_ID}`,
        order: `${ROOTS.DASHBOARD}/pharmacy/order/${MOCK_ID}`,
      },
    },
    diagnostics: {
      root:`${ROOTS.DASHBOARD}/diagnostics`,
    ...
    general: {
      ...
      course: `${ROOTS.DASHBOARD}/patient`,
    },
    user: {
